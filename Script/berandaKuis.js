...
function optionSelected(answer){
    ...
    if(userAns == correctAns){
        ...
        //if answers is incorrect then autimatically selected the correct answer
...
function showResultBox(){
    ...
    if(userScore > 7){
        let scoreTag = '<span>Anda mendapatkan nilai <p>' + userScore + '</p> dari <p>'+ questions.length +'</p></span>';
...
function queCounter2(index){
    const Top_ques_counter = quiz_box.querySelector(".timer_sec");
    let totalQuesCountTag2 = index;
    Top_ques_counter.innerHTML = totalQuesCountTag2;
}