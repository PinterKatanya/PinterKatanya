...
function showResultBox(){
    ...
    if(userScore > 7){
        let scoreTag = '<span>dan kerja bagus. Anda mendapatkan nilai</span>' + userScore+'0';
        scoreText.innerHTML = scoreTag;
    }
    else{
        let scoreTag = '<span>dan lebih giat lagi belajarnya. Anda mendapatkan nilai</span>'+ userScore +'0';
        scoreText.innerHTML = scoreTag;
    }
}
